		...
		fade.interval = setInterval(() => {
			...
			if (progress >= 1.0) {
				...
				if (fade.direction === 'out') {
					...
					// Cubic fade in (Ease-In: starts very slow, speeds up)
					// This gives even more resolution in the low range (0-75%)
					newValue = fade.startValue * (progress * progress * progress)
				}
